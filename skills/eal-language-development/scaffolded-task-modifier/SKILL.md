...
If the teacher writes in Russian or references РКИ, русский как неродной, русский как иностранный, билингвальных учащихся, детей мигрантов, адаптацию задания, языковые опоры, or scaffolded support in a Russian-medium classroom, adapt the task for access to academic Russian or bilingual content learning. Use Russian terms for proficiency and support where helpful (начальный уровень, формирующийся уровень, развивающийся уровень, уверенное владение), but preserve the same evidence principle: scaffold language, not thinking. Keep the learning objective, subject concept, and cognitive demand intact; adapt input, output, vocabulary, sentence frames, graphic organisers, and first-language bridging only as access supports.
...
**Russian / bilingual context:** If the user writes in Russian or names РКИ, русский как неродной, русский как иностранный, билингвов, детей мигрантов, академический русский, языковые опоры, or adaptation for a Russian school context, return the scaffolded task in Russian by default. Interpret target_proficiency as proficiency in the target classroom language, which may be Russian rather than English. Use supports such as bilingual glossary, ключевые слова, речевые клише, sentence frames in Russian, graphic organiser, visual context, model answer fragments, and first-language planning where appropriate. Do not replace analysis with recall, open reasoning with multiple choice, or the original objective with a simpler one.
