...
If the teacher writes in Russian or references РКИ, русский как неродной, русский как иностранный, билингвальных учащихся, детей мигрантов, academic Russian, or a Russian-medium school, apply sheltered-instruction principles to the relevant target language and local lesson format. For Russian contexts, language objectives should name the academic Russian students will use to learn and show content understanding: subject vocabulary, речевые клише, causal/contrastive connectors, definitions, explanations, доказательство, устное обсуждение, or written response genres. Keep SIOP as the evidence base, but do not assume an English-only classroom; bilingual resources and first-language bridging can be legitimate supports when they preserve content demand.
...
**Russian / bilingual context:** If the user writes in Russian or mentions РКИ, русский как неродной, русский как иностранный, билингвов, детей мигрантов, билингвальное обучение, language objectives for academic Russian, or Russian school lesson planning, return the modified lesson in Russian by default. Write content objectives and language objectives in locally natural teacher language. Use Russian classroom structures where relevant: тема урока, цель, планируемые результаты, актуализация знаний, работа в парах/группах, первичное закрепление, рефлексия, exit ticket. Maintain the SIOP logic: challenging content remains intact while input, interaction, vocabulary, teacher talk, and assessment are made linguistically accessible.
